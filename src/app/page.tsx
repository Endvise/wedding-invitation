    ...
    <main className="w-full">
      ...
      >
        <div className="max-w-md">
          ...
          <h1 className="text-5xl font-light text-[#3d3229] mb-6">
      ...
      >
        <div className="max-w-md w-full">
          <div className="text-center mb-12">
            <p className="text-4xl font-light text-[#3d3229] mb-4">
              초대합니다
            </p>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm mb-8">
            ...
            <div className="space-y-3 text-[#6b5f52]">
              ...
              <div className="flex justify-between">
                <span>연락처</span>
                <a href={`tel:${wedding.phone}`} className="text-[#857b5c]">
                  {wedding.phone}
                </a>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <form onSubmit={handleGuestbookSubmit} className="space-y-3 mb-6">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#857b5c]"
              />
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-[#857b5c] resize-none"
              />
              <input
                type="password"
              ...
              <button
                ...
                className="w-full py-2 bg-[#857b5c] text-white rounded-lg text-sm disabled:opacity-50"
              >
              ...
              {comments.length === 0 ? (
                ...
                comments.map((comment) => (
                  <div key={comment.id} className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-[#9a8b7c] text-xs mt-2">
      ...
      >
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm">
            ...
            <div className="space-y-4 text-[#6b5f52]">
              ...
              <a
                ...
                className="block text-center py-3 bg-[#857b5c] text-white rounded-lg mt-4"
              >
                지도 보기
              </a>
            </div>
          ...
          <button
            ...
            className="w-full py-3 mt-6 border border-[#857b5c] text-[#857b5c] rounded-lg"
          >
            청첩장 공유하기
          </button>
        </div>
...
function AccountButton({
  ...
  return (
    ...
    >
      ...
      <span className={`text-sm ${copied ? "text-green-600" : "text-[#857b5c]"}`}>
        {copied ? "복사됨" : "복사"}
      </span>
    </button>
  );
